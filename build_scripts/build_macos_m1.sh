...
if [ "$NOTARIZE" ]; then
  electron-osx-sign HDDcoin\ Light\ Wallet-darwin-arm64/HDDcoin\ Light\ Wallet.app --platform=darwin \
...
mv HDDcoin\ Light\ Wallet-darwin-arm64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="HDDcoin-Wallet-$HDDCOIN_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
electron-installer-dmg dist/HDDcoin\ Light\ Wallet-darwin-arm64/HDDcoin\ Light\ Wallet.app HDDcoin-Wallet-$HDDCOIN_INSTALLER_VERSION-arm64 \
